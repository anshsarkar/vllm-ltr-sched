...
echo "=== vllm-ltr 8B LMSYS Benchmark Runner ==="
...
echo ""
echo "  4 schedulers x 6 request rates = 24 runs (~2-3 hours)"
echo ""

bash "$BENCH_DIR/bench-lmsys.sh" 2>&1 | tee "$BENCH_DIR/RESULTS/bench_8b_lmsys_run.log"
