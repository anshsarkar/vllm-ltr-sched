...
def plot_metrics(csv_path, output_dir):
    ...
    output_path = os.path.join(output_dir, "mean_nlatency_comparison_sharegpt_h100_8b.png")
    plt.tight_layout()
...
def main():
    ...
    output = args.output or os.path.join(folder, "metrics_sharegpt_h100_8b.csv")
