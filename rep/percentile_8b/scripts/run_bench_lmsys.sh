...
echo "=== vllm-ltr 8B LMSYS Percentile-10 Benchmark Runner ==="
...
bash "$BENCH_DIR/bench-rep-pctl10-lmsys.sh" 2>&1 | tee "$BENCH_DIR/RESULTS/bench_rep_pctl10_lmsys_run.log"

echo ""
echo "=== LMSYS Percentile-10 Benchmarks complete ==="
