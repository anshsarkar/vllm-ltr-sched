...
echo "=== vllm-ltr 8B ShareGPT Percentile-10 Benchmark Runner ==="
...
echo "  (pctl10 runs first)"
echo ""

bash "$BENCH_DIR/bench-rep-pctl10-sharegpt.sh" 2>&1 | tee "$BENCH_DIR/RESULTS/bench_rep_pctl10_sharegpt_run.log"

echo ""
echo "=== ShareGPT Percentile-10 Benchmarks complete ==="
