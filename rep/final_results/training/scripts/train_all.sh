...
# class82 (bucket_width=100, ~82 classes)
echo "=== Training class82 ==="
...
# pctl10 (percentile-balanced, 10 classes)
echo "=== Training pctl10 ==="
python trainer_percentile.py --config configs/config_prefill_opt_classify.txt \
    --file jsonfiles/lmsys-Meta-Llama-3-8B-Instruct-t1.0-s0-l8192-c20000:30000-rFalse.jsonl \
    --job-dir MODEL \
    --run-id opt-125m-llama3-8b-lmsys-pctl10-b4 \
    --batch-size 4 \
    --num-classes 10 \
    --epoch 5 \
...
python trainer_percentile.py --config configs/config_prefill_opt_classify.txt \
    --file jsonfiles/llama3-8b-sharegpt-train-t1-s0-8192.jsonl \
    --job-dir MODEL \
    --run-id opt-125m-llama3-8b-sharegpt-pctl10-b4 \
    --batch-size 4 \
    --num-classes 10 \
    --epoch 5 \
    2>&1 | tee "$LOG_DIR/train_sharegpt_pctl10.log"

# width10 (bucket_width=10, ~820 classes)
echo "=== Training width10 ==="
python trainer.py --config configs/config_prefill_opt_classify.txt \
    --file jsonfiles/lmsys-Meta-Llama-3-8B-Instruct-t1.0-s0-l8192-c20000:30000-rFalse.jsonl \
    --job-dir MODEL \
    --run-id opt-125m-llama3-8b-lmsys-class-trainbucket10-b4 \
    --batch-size 4 \
    --label-group-size 10 \
    --epoch 5 \
...
python trainer.py --config configs/config_prefill_opt_classify.txt \
    --file jsonfiles/llama3-8b-sharegpt-train-t1-s0-8192.jsonl \
    --job-dir MODEL \
    --run-id opt-125m-llama3-8b-sharegpt-class-trainbucket10-b4 \
    --batch-size 4 \
    --label-group-size 10 \
    --epoch 5 \
