...
echo "=== vllm-ltr 8B LMSYS Final Benchmark Runner ==="
...
# ---- Run ----
mkdir -p "$PROJECT_ROOT/rep/final_results/benchmarks/results/lmsys"
...
bash "$BENCH_DIR/bench-final-lmsys.sh" 2>&1 | tee "$PROJECT_ROOT/rep/final_results/benchmarks/results/lmsys/bench_final_lmsys_run.log"

echo ""
echo "=== LMSYS Final Benchmarks complete ==="
