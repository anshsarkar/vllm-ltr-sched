...
echo "=== vllm-ltr 8B LMSYS OPT-350m Benchmark Runner ==="
...
for config in \
    ...
    "MODEL/results/opt-350m-llama3-8b-lmsys-class-trainbucket100-b4/usage_config.json"; do
...
bash "$BENCH_DIR/bench-rep-opt350m-lmsys.sh" 2>&1 | tee "$BENCH_DIR/RESULTS/bench_rep_opt350m_lmsys_run.log"

echo ""
echo "=== LMSYS OPT-350m Benchmarks complete ==="
